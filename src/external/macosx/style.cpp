     ...
     case CE_DockWidgetTitle:
         {
						...
						painter->setPen( QColor(142,142,142) );
						QLinearGradient gradient(0,1,0,14);
						...
						painter->drawRect( QRect( QPoint(-1,0), QSize(width+1, 16) ) );
						...
						if(style=="aqua") {
							...
							painter->drawLine( QPoint(width-1,0), QPoint(width-1,16) );
						}
						if(style=="default") {
						...
						painter->drawText(QPoint(13,12), dockWidgetOption->title);
											...
											const QWidget * widget ) const
{
	...
	switch (standardPixmap) {
		case SP_TitleBarNormalButton:
			{ //QPixmap pixmap(":icons/logo.png"); return pixmap;
		...
		case SP_TitleBarCloseButton:
			{ //QPixmap pixmap(":icons/TitleBarCloseButton.png"); return pixmap;
